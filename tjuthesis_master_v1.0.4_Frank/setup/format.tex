...
\setcounter{tocdepth}{2}
\titlecontents{chapter}[0em]{\vspace{7pt}\xiaosi\song\bfseries}%
             {\prechaptername\thecontentslabel\postchaptername\quad}{} %
             {\hspace{.5em}\titlerule*[7pt]{.}\xiaosi\contentspage}
\titlecontents{section}[2em]{\vspace{7pt}\xiaosi\song} %
            {\thecontentslabel\quad}{} %
            {\hspace{.5em}\titlerule*[7pt]{.}\xiaosi\contentspage}
\titlecontents{subsection}[4em]{\vspace{7pt}\xiaosi\song} %
            {\thecontentslabel\quad}{} %
            {\hspace{.5em}\titlerule*[7pt]{.}\xiaosi\contentspage}
...
\long\def\@makecaption#1#2{%
   ...
   \sbox\@tempboxa{\wuhao\song{#1\qquad #2} }%
   \ifdim \wd\@tempboxa >\hsize
     \wuhao\song{#1\qquad #2} \par
   \else
...
\fancypagestyle{only_foot}{% 设置摘要、目录的页眉页脚风格：无页眉（（天津大学关于博士、硕士学位论文统一格式的规定 2016.10.24）貌似要这种only_foot 的样式）
    \fancyhf{}%
    \fancyfoot[C]{\song\xiaowu ~\thepage~ }
...
%\cleardoublepage%
   \phantomsection
    ...
    \begin{titlepage}
      ...
      \begin{center}
      \renewcommand{\baselinestretch}{1.25} % 设置行距1.25
      \erhao\textbf{\@etitle}
      \renewcommand{\baselinestretch}{1.25} % 设置行距 1.38
      \end{center}
...
\chapter*{\centering\song\erhao\textbf{摘\qquad 要}} \thispagestyle{empty}
...
%%%%%%%%%%%%%%%%%%%   English Abstract  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\chapter*{\centering\erhao\textbf{ABSTRACT}} \thispagestyle{empty}
